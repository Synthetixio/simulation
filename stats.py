...
def mean_profit_fraction(havven: "model.HavvenModel") -> float:
...
def mean_banker_profit_fraction(havven: "model.HavvenModel") -> float:
...
def mean_arb_profit_fraction(havven: "model.HavvenModel") -> float:
...
def mean_rand_profit_fraction(havven: "model.HavvenModel") -> float:
...
def mean_nomshort_profit_fraction(havven: "model.HavvenModel") -> float:
...
def mean_escrownomshort_profit_fraction(havven: "model.HavvenModel") -> float:
...
def fiat_supply(havven: "model.HavvenModel") -> float:
...
def curit_demand(havven: "model.HavvenModel") -> float:
...
def curit_supply(havven: "model.HavvenModel") -> float:
...
def nomin_demand(havven: "model.HavvenModel") -> float:
...
def nomin_supply(havven: "model.HavvenModel") -> float:
