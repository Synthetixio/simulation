...
\noindent What quantity of escrowed curits can be accumulated in this fashion?
...
an agent can issue twice as the face value of its initial curit supply.
...
Of course, the reader may easily object that these situations are impossible both
...
The question now to answer is: is this a runaway feedback loop? If it is,
...
elasticities in the market, which we do not know, but we will hand wave a little to try to
