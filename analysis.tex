...
\begin{align*}
    ...
    &C_e = C \cdot U \ && &(\CUR{}) && &\text{ : Quantity of reserved curits against which nomins have been issued.} \\
    &N = \frac{U \cdot C \cdot P_c}{P_n} \ && &(\NOM{}) && &\text{ : Quantity of nomins. This can float.}
\end{align*}
\\
...
\begin{align*}
    ...
    V_i &= (C - C_e) \cdot S_i \ && &(\frac{\CUR{}}{\text{sec}}) && &\text{ : nomin issuance rate.} \\
    V_r &= C_e \cdot S_r \ && &(\frac{\CUR{}}{\text{sec}}) && &\text{ : curit redemption rate.} \\
